...
# Here we define a parent traceable and inside that we have the two traceables , so langsmith notices a trace as running and establishes a parent child type connection
import os
