...
# We now add traceable to track the chunking and embedding creation too via Langsmith. The traceable function can also be used to add tags and metadata to each run.
#However, it still executes as 2 separate traces and not a single one.
import os
